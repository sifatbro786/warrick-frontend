...
import { ArrowUpRight, ChevronRight, Globe, Layers, Play, ShieldCheck } from "lucide-react";
...
const buildSrcSet = (photoId) =>
    [1280, 1920, 2560].map((width) => `${unsplash(photoId, width)} ${width}w`).join(", ");
...
const HERO_ENTITIES = [
    ...
    },
    {
        ...
        statement: "Consumer products and commerce platforms engineered around everyday utility.",
...
export default function HeroSection({ onWatchFilm }) {
    ...
    const active = HERO_ENTITIES.find((entity) => entity.id === activeId) ?? HERO_ENTITIES[0];
            ...
            <div className="relative mx-auto flex w-full max-w-360 flex-1 flex-col px-5 sm:px-6 lg:px-10">
                <div className="grid flex-1 items-center gap-14 py-14 lg:grid-cols-12 lg:gap-8 lg:py-20">
                    ...
                    >
                        ...
                        >
                            <span aria-hidden="true" className="size-1.25 rotate-45 bg-gold" />
                        ...
                        >
                            Architecting{" "}
                            <span className="text-gold-gradient">Sustainable Growth</span> Across
                            Global Industries.
                        </motion.h1>
                        ...
                        >
                            We build enduring businesses where engineering discipline meets design
                            intent — from energy infrastructure to advanced mobility.
