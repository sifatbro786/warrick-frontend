    ...
    return (
        ...
        >
            <h1 className="sr-only">
                Warrick Group, a global enterprise across energy, consumer technology and mobility
            </h1>
          ...
          ------------------------------------------------------------------ */}
           ...
           a fade never slides. */
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#151172]/5" />
              <div className="absolute inset-0 bg-linear-to-r from-[#701E85] via-[#151172]/75 to-[#701E85]/15" />
              <div className="absolute inset-x-0 bottom-0 h-1/3 bg-linear-to-t from-[#701E85] to-transparent" />
            </div> */}
